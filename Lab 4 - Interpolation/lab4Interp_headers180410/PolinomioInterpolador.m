...
% linear. Nao eh necessario retornar cA para a atividade 4.
%
...
if (nargin < 3)
    maxCond = 1e20; % dangerous. but if you do not want a limit...
end
...
% pode usar esta parte para nao tentar resolver o sistema
% se for muito mal condicionado
cA = cond(A); 
if (cA > maxCond)
    p = []; % empty answer
    return; % do not attempt to solve
end
